...
namespace osu_player.Visualization
{
    ...
    {//https://github.com/ppy/osu/blob/master/osu.Game/Screens/Menu/LogoVisualisation.cs
        public BeatmapSongPlayer BeatmapSongPlayer { get; }
        ...
        {
            var track = BeatmapSongPlayer.IsPlaying ? BeatmapSongPlayer.CurrentTrack : null;
            ...
            for (int i = 0; i < bars_per_visualiser; i++)
            {
                ...
                {
                    float targetAmplitude = temporalAmplitudes[(i + indexOffset) % bars_per_visualiser] * 0.5f;
